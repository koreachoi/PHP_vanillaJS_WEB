...
<?php
    ...
    $rq = "SELECT * FROM c_content WHERE cid LIKE '$content_id'";
    $rqresult = $mysqli->query($rq);
    $rqrows = mysqli_fetch_assoc($rqresult);

    $edtitle = $rqrows['ctitle'];
    $edmain = $rqrows['cmain'];
?>
<?php
?>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/edit_console_post_style.css">
...
<div class="main">
    <div class="sub_main">
        ...
        <div class="post_area">
            ...
            <form class="post_form" method="POST" action="ok_edit_console_post.php?ecid=<?php echo $content_id ?>">
                <input type="button" value="POST" class="post_btn">
                <input type="text" placeholder="INPUT TITLE" maxlength="50" 
                name="c_title" class="content_title" value="<?php echo $edtitle ?>">
                <textarea wrap="on" maxlength = "2000" 
                    name="c_main" class="content_main" ><?php echo $edmain ?>
                </textarea>
            </form>
        </div>
...
<script src="../js/edit_console_post.js"></script>
