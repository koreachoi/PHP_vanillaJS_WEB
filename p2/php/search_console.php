...
<?php
    ...
    $search_case = $_POST['s_case'];
    $search_text = $_POST['s_name'];

    if($search_case == 'id'){
        $q = "SELECT * FROM c_content
        WHERE uid LIKE '%$search_text%'
        ORDER BY 'cid' DESC";
    }else if($search_case == 'title'){
        $q = "SELECT * FROM c_content
        WHERE ctitle LIKE '%$search_text%'
        ORDER BY 'cid' DESC";
    }
    // search sorting console_content 
...
<?php
    ...
    if($search_case == 'id'){
        $q = "SELECT * FROM c_content 
        WHERE uid LIKE '%$search_text%'
        ORDER BY cid desc limit $start, $list_num";
    }else if($search_case == 'title'){
        $q = "SELECT * FROM c_content
        WHERE ctitle LIKE '%$search_text%'
        ORDER BY 'cid' DESC";
...
<div class="main">
    <div class="sub_main">
        <div class="content_layout">
            <div class="head_text">Console</div>
